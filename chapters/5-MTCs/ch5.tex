...
\begin{dict}\label{time-reversal-dict} Given a topological phase of matter described by the modular caterory chiral central charge pair $(\cC,c_{-})$, the {\em time reversal conjugate} of that phase is described by the pair $(\overline{\cC},-c_{-})$.\Note{I don't know how to describe time well, in this context. Physical intuition would be really good here... This could also be a good place to have a mirror-image type picture to say why this is a good definition.}
\end{dict}
